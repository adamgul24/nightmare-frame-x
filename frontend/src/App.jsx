...
const socket = io("https://real-time-threat-dashboard.onrender.com"); // Your backend
...
const App = () => {
  ...
  useEffect(() => {
    const fetchThreats = async () => {
      try {
        const res = await axios.get("https://real-time-threat-dashboard.onrender.com/api/threats");
